...
public class ArrayvsSparse extends AppCompatActivity {
    SparseArray<Long> performanceMap = new SparseArray<>();
    //ArrayMap<Integer, Long> performanceMap = new ArrayMap<>();
        ...
        if (request != null) {
            new APIHelper().postData(request, new StringCallBack() {
                ...
                public void execute(String str) {
                    Toast.makeText(ArrayvsSparse.this, "aaaaa", Toast.LENGTH_SHORT).show();
                }
            });
        }
